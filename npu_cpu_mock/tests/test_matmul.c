...
static int test_matmul_identity_fp32(void) {
    ...
    cube_matmul(TENSOR(OFF_A, NPU_DTYPE_FP32), TENSOR(OFF_B, NPU_DTYPE_FP32),
...
static int test_matmul_fp16(void) {
    ...
    cube_matmul(TENSOR(OFF_A, NPU_DTYPE_FP16), TENSOR(OFF_B, NPU_DTYPE_FP16),
...
static int test_matmul_bias_int8_fp16(void) {
    ...
    cube_matmul_bias(TENSOR(OFF_A, NPU_DTYPE_INT8), TENSOR(OFF_B, NPU_DTYPE_INT8),
...
static int test_matmul_bias_fp16_io_fp16_compute(void) {
    ...
    cube_matmul_bias(TENSOR(OFF_A, NPU_DTYPE_FP16), TENSOR(OFF_B, NPU_DTYPE_FP16),
