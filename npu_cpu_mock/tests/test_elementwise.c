...
static int test_add_fp32(void) {
    ...
    vector_add(TENSOR(OFF_A, NPU_DTYPE_FP32), TENSOR(OFF_B, NPU_DTYPE_FP32),
...
static int test_add_fp16(void) {
    ...
    vector_add(TENSOR(OFF_A, NPU_DTYPE_FP16), TENSOR(OFF_B, NPU_DTYPE_FP16),
...
static int test_mul_fp32(void) {
    ...
    vector_mul(TENSOR(OFF_A, NPU_DTYPE_FP32), TENSOR(OFF_B, NPU_DTYPE_FP32),
               TENSOR(OFF_OUT, NPU_DTYPE_FP32), N, NPU_DTYPE_FP32);
    float* out = L1_PTR(float, OFF_OUT);
    for (int i = 0; i < N; i++)
...
static int test_mul_scalar_fp32(void) {
    ...
    vector_mul_scalar(TENSOR(OFF_A, NPU_DTYPE_FP32), TENSOR(OFF_OUT, NPU_DTYPE_FP32),
...
static int test_gelu_fp32(void) {
    ...
    vector_gelu(TENSOR(OFF_A, NPU_DTYPE_FP32), TENSOR(OFF_OUT, NPU_DTYPE_FP32),
                4, NPU_DTYPE_FP32);
    float* out = L1_PTR(float, OFF_OUT);
...
static int test_gelu_fp16(void) {
    ...
    vector_gelu(TENSOR(OFF_A, NPU_DTYPE_FP16), TENSOR(OFF_OUT, NPU_DTYPE_FP16),
                4, NPU_DTYPE_FP16);
    for (int i = 0; i < 4; i++)
...
static int test_add_int8(void) {
    ...
    vector_add(TENSOR(OFF_A, NPU_DTYPE_INT8), TENSOR(OFF_B, NPU_DTYPE_INT8),
...
static int test_add_int16(void) {
    ...
    vector_add(TENSOR(OFF_A, NPU_DTYPE_INT16), TENSOR(OFF_B, NPU_DTYPE_INT16),
...
static int test_mul_int8(void) {
    ...
    vector_mul(TENSOR(OFF_A, NPU_DTYPE_INT8), TENSOR(OFF_B, NPU_DTYPE_INT8),
...
static int test_matmul_int8(void) {
    ...
    cube_matmul(TENSOR(OFF_A, NPU_DTYPE_INT8), TENSOR(OFF_B, NPU_DTYPE_INT8),
